...
<div class="manual">
	<h1 class="h1"><img src="h1.manual.gif" width="116" height="18" alt="매뉴얼 다운로드"></h1>
	<div class="tx">
		<h2>사용자 매뉴얼 다운로드(User Manual)</h2>
	...
	<div class="tx">
		<h2>스킨제작 매뉴얼 다운로드(XE Skin Creation Manual)</h2>
		<table border="1" cellspacing="0" class="dList" summary="한글, 영문, 일문, 중문 버전의 PDF와 DOCX 포멧이 준비되어 있습니다.">
			<col /><col width="120" />
			<tr>
				<th scope="col">파일 이름</th>
	...
	<div class="tx">
		<h2>개발자 매뉴얼 다운로드(XE Developer Manual)</h2>
		<table border="1" cellspacing="0" class="dList" summary="한글, 영문, 일문, 중문 버전의 PDF와 DOCX 포멧이 준비되어 있습니다.">
			<col /><col width="120" />
			<tr>
				<th scope="col">파일 이름</th>
	...
	<div class="tx">
		<h2>기타 문서 다운로드(Additional Documents)</h2>
		<table border="1" cellspacing="0" class="dList" summary="한글, 영문, 일문, 중문 버전의 PDF와 DOCX 포멧이 준비되어 있습니다.">
			<col /><col width="120" />
			<tr>
				<th scope="col">파일 이름</th>
			...
			<tr>
				<td><a href="http://www.xpressengine.com/faq/entry/XE_1.5_%EC%97%85%EB%8D%B0%EC%9D%B4%ED%8A%B8_%EA%B0%80%EC%9D%B4%EB%93%9C">XE 1.5 업데이트 가이드 v1.0 (Korean, HTML)</a></td>
				<td>2012-05-10</td>
			</tr>
			<tr>
			...
			<tr>
				<td><a href="http://www.xpressengine.com/faq/entry/XE_1.5_%EC%BA%90%EC%8B%9C_%EC%84%A4%EC%A0%95_%EA%B0%80%EC%9D%B4%EB%93%9C">XE 1.5 캐시 설정 가이드 v1.0 (Korean, HTML)</a></td>
				<td>2012-05-31</td>
			</tr>
		</table>
	</div>
	<div class="notice">
		<p>이 문서는 정보 제공의 목적으로만 제공됩니다. NHN(주)는 이 문서에 수록된 정보의 완전성과 정확성을 검증하기 위해 노력하였으나, 발생할 수 있는 내용상의 오류나 누락에 대해서는 책임지지 않습니다. 따라서 이 문서의 사용이나 사용 결과에 따른 책임은 전적으로 사용자에게 있으며, NHN(주)는 이에 대해 명시적 혹은 묵시적으로 어떠한 보증도 하지 않습니다.			</p>
		<p>관련 URL 정보를 포함하여 이 문서에서 언급한 특정 소프트웨어 상품이나 제품은 해당 소유자가 속한 현지 및 국내외 관련법을 따르며, 해당 법률을 준수하지 않음으로 인해 발생하는 모든 결과에 대한 책임은 전적으로 사용자 자신에게 있습니다.			</p>
		<p>NHN(주)는 이 문서의 내용을 예고 없이 변경할 수 있습니다. </p>
	</div>
</div>
<style type="text/css">
.h1{ height:40px; margin:0;}
.tx{ position:relative;margin:0 0 2em 0}
.tx h2{ font-size:14px}
.dList{ border:0; border-top:2px solid #999; width:100%;}
.dList a{ text-decoration:none}
.dList a:hover,
.dList a:active,
.dList a:focus{ text-decoration:underline}
.dList th,
.dList td{ border:0; border-bottom:1px solid #ddd; padding:7px 10px;}
.dList th{ text-align:left}
.dList td{}
.notice{ line-height:1.5; color:#666}
</style>
