...
<style type="text/css">
.xeOverview{ font-size:12px; font-family:돋움, Dotum, Tahoma, Geneva, sans-serif;}
.h1{ margin:0; height:40px;}
.h2{ margin:0 0 20px 0;}
.overview{ margin:0 0 20px 0; padding:178px 0 0 0; height:0; overflow:hidden; background:url(xeOverview.gif) no-repeat;}
.tx{ color:#666; line-height:1.4; font-size:11px; margin:0 0 20px 0;}
.structure{ background:url(h2.structure.gif) no-repeat 18px 0; margin:0 0 20px 0;}
.structure table{ width:100%; height:320px; color:#666; border:0; border-top:1px solid #7a7a7a; border-bottom:1px solid #7a7a7a;}
.structure th,
.structure td{ border:0; padding:0;}
.structure th span{ display:inline-block; height:0; overflow:hidden;}
.structure td{ padding:5px 0;}
.structure .vr{ border-bottom:1px solid #d3d3d3;}
.install{ width:47%; table-layout:fixed; color:#666; border:1px solid #ebebeb; border-top:0;float:left;margin:5px}
.install th{ background:#ebebeb; border:0; padding:4px 20px; text-align:left;border-bottom:1px solid #fff;}
.install .version th{background-color:rgb(202, 202, 202)!important;}
.install td{ border:0; padding:5px 20px; font-size:11px; vertical-align:top;}
.install td span{ font-size:14px; color:#909090;}
</style>
<div class="xeOverview">
	<h1 class="h1"><img src="h2.aboutXe.gif" alt="XE 소개"/></h1>
	...
	<h2 class="h2"><img src="h2.module.gif" alt="모듈형(조립식) 구조" width="116" height="25" /></h2>
...
XpressEngine 프로젝트의 참여에는 제한이 없습니다. 이미 많은 분들이 개발, 디자인, 마크업, 기획 등의 전문 분야는 물론 다국어 번역, 문제점 보고 등  기능 개선 및 문제점 해결을 위해 많은 노력을 해주고 계십니다. 참여를 원하시는 분은 XpressEngine 공식 웹사이트의 개발자 포럼 또는 각 프로그램/ 스킨별 프로젝트 사이트에 방문하시면 됩니다.</p>
	<h2 class="h2"><img src="h2.install.gif" alt="XE 설치 환경" width="71" height="24" /></h2>
