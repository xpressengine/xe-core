...
<div class="well">
	<p>이 문서는 정보 제공의 목적으로만 제공됩니다. `NAVER(주)`는 이 문서에 수록된 정보의 완전성과 정확성을 검증하기 위해 노력하였으나, 발생할 수 있는 내용상의 오류가 있거나 누락되었을 수 있습니다. 이 문서의 사용이나 사용 결과에 따른 책임은 전적으로 사용자에게 있으며, `NAVER(주)`는 이에 대해 명시적 혹은 묵시적으로 어떠한 보증도 하지 않습니다.</p>
	...
	<p>`NAVER(주)`는 이 문서의 내용을 예고 없이 변경할 수 있습니다.</p>
</div>
