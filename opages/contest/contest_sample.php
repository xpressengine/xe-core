...
/* GNB */
#gnb{ position:absolute; top:75px; left:400px;top:57px}
#gnb ul{ list-style:none; margin:0; padding:0;}
#gnb li{ float:left;padding-right:50px; *zoom:1;}
#gnb a{display:inline-block;width:68px;height:16px;background:url(../../layouts/xe_contest_2012/img/gnb.gif) no-repeat 0 0;font-size:0;}

#gnb li.m1 a{ background-position:0 0;}
#gnb li.m2 a{ background-position:-119px 0;}
#gnb li.m3 a{ background-position:-222px 0;}
#gnb li.m4 a{ background-position:-348px 0;}
 ...
 <script type="text/javascript">
	...
	jQuery(function($){
 	...
 	<div style="padding-left:30px;height:33px;padding-top:35px;padding-bottom:50px;font-size:25px;color:#ffffff;font-weight:bold">
		<p style="margin-right:40px"><a href="http://www.xpressengine.com/contest" style="color:#eee" target="_blank">XE 사용자 공모전</a></p>
		<div id="gnb">
			<ul class="nonemenu">
				<li class="m1"><a href="{getUrl('','mid','contest')}" target="_blank">공모전 안내</a></li>
				<li class="m2"><a href="{getUrl('','mid','contestWay')}" target="_blank">참가방법</a></li>
				<li class="m3"><a href="{getUrl('','mid','contestRegistration')}" target="_blank">공모작 등록</a></li>
				<li class="m4"><a href="{getUrl('','mid','contestProposal')}" target="_blank">질문/답변<span class="ir">블로그</span></a></li>
			</ul>
		</div>
	</div>
	...
	<div style="float:left;height:100%;width:17%;padding-top:10px;">
		<ul class="parn">
			...
			<li><span>포럼관련 페이지 보기</span>
				<ul class="chrn">
					<li><a href="#" onclick="show('category_list')">카테고리 리스트 디자인</a></li>
					<li><a href="#" onclick="show('forum_list')">카테고리 > 포럼 리스트 디자인</a></li>
					<li><a href="#" onclick="show('forum_view')">포럼 보기 디자인</a></li>
					<li><a href="#" onclick="show('forum_content')">포럼 인용 쓰기 디자인</a></li>
					<li><a href="#" onclick="show('forum_write')">포럼 쓰기 디자인</a></li>
					<li><a href="#" onclick="show('forum_ben')">포럼 사용자 차단 디자인</a></li>
					<li><a href="#" onclick="show('forum_delete')">포럼 삭제 디자인</a></li>
				</ul>
			</li>
			<li><span>기타</span>
				<ul class="chrn">
	...
	<div style="float:right;width:80%;border-left:solid 1px #565960;margin:0 0 10px 0;padding:20px 0 0 10px;">
		...
		<div class="__content" id="category_list">
			<img src="./image/05-01.png" />
		</div>
		<div class="__content" id="forum_list">
			<img src="./image/05-02.png" />
		</div>
		<div class="__content" id="forum_view">
			<img src="./image/05-03.png" />
		</div>
		<div class="__content" id="forum_content">
			<img src="./image/05-04.png" />
		</div>
		<div class="__content" id="forum_write">
			<img src="./image/05-05.png" />
		</div>
		<div class="__content" id="forum_ben">
			<img src="./image/05-06.png" />
		</div>
		<div class="__content" id="forum_delete">
