...
(function ($) {
			...
			if(resourceURL !== null && resourceURL !== undefined) {
				...
				for(var j = 0, l = shortURLList.length; j < l; j++) {
					...
					if(resourceURL.match(regExp) !== null) {
						//AJAX to http://api.longurl.org/v2/expand?url=https://bit.ly/JATvIs&format=json&callback=hhh
						var ajaxopts = $.extend({
	...
	$.fn.oembed.providers = [
		...
		// new $.fn.oembed.OEmbedProvider("youtube", "video", ["youtube\\.com/watch.+v=[\\w-]+&?", "youtu\\.be/[\\w-]+"], 'https://www.youtube.com/oembed', {
		// 	useYQL: 'json'
		// }),
		...
		// 	}
		// }),
		new $.fn.oembed.OEmbedProvider("wistia", "video", ["wistia.com/m/.+", "wistia.com/embed/.+", "wi.st/m/.+", "wi.st/embed/.+"], 'https://fast.wistia.com/oembed', {
			useYQL: 'json'
		}),
		...
		new $.fn.oembed.OEmbedProvider("minoto-video", "video", ["https://api.minoto-video.com/publishers/.+/videos/.+", "https://dashboard.minoto-video.com/main/video/details/.+", "https://embed.minoto-video.com/.+"], "https://api.minoto-video.com/services/oembed.json", {
			useYQL: 'json'
		}),
		...
		new $.fn.oembed.OEmbedProvider("ustream", "video", ["ustream\\.tv/recorded/.*"], "https://www.ustream.tv/oembed", {
			useYQL: 'json'
		}),
		new $.fn.oembed.OEmbedProvider("videojug", "video", ["videojug\\.com/(film|payer|interview).*"], "https://www.videojug.com/oembed.json", {
			useYQL: 'json'
		}),
		new $.fn.oembed.OEmbedProvider("sapo", "video", ["videos\\.sapo\\.pt/.*"], "https://videos.sapo.pt/oembed", {
			useYQL: 'json'
		}),
		new $.fn.oembed.OEmbedProvider("vodpod", "video", ["vodpod.com/watch/.*"], "https://vodpod.com/oembed.js", {
			useYQL: 'json'
		}),
		...
		new $.fn.oembed.OEmbedProvider("5min", "video", ["www\\.5min\\.com/.+"], 'https://api.5min.com/oembed.xml', {
			useYQL: 'xml'
		}),
		new $.fn.oembed.OEmbedProvider("National Film Board of Canada", "video", ["nfb\\.ca/film/.+"], 'https://www.nfb.ca/remote/services/oembed/', {
			useYQL: 'json'
		}),
		...
		new $.fn.oembed.OEmbedProvider("dotsub", "video", ["dotsub\\.com/view/.+"], "https://dotsub.com/services/oembed", {
			useYQL: 'json'
		}),
		...
		new $.fn.oembed.OEmbedProvider("justin.tv", "video", ["justin.tv/.+"], 'https://api.justin.tv/api/embed/from_url.json', {
			useYQL: 'json'
		}),

		//Audio
		new $.fn.oembed.OEmbedProvider("official.fm", "rich", ["official.fm/.+"], 'https://official.fm/services/oembed', {
			useYQL: 'json'
		}),
		new $.fn.oembed.OEmbedProvider("chirbit", "rich", ["chirb.it/.+"], 'https://chirb.it/oembed.json', {
			useYQL: 'json'
		}),
		...
		new $.fn.oembed.OEmbedProvider("mixcloud", "rich", ["mixcloud.com/.+"], 'https://www.mixcloud.com/oembed/', {
			useYQL: 'json'
		}),
		new $.fn.oembed.OEmbedProvider("rdio.com", "rich", ["rd.io/.+", "rdio.com"], "https://www.rdio.com/api/oembed/"),
		new $.fn.oembed.OEmbedProvider("Soundcloud", "rich", ["soundcloud.com/.+", "snd.sc/.+"], "https://soundcloud.com/oembed", {
			format: 'js'
		}),
		...
		//Photo
		new $.fn.oembed.OEmbedProvider("deviantart", "photo", ["deviantart.com/.+", "fav.me/.+", "deviantart.com/.+"], "https://backend.deviantart.com/oembed", {
			format: 'jsonp'
		}),
		...
		new $.fn.oembed.OEmbedProvider("flickr", "photo", ["flickr\\.com/photos/.+"], "https://flickr.com/services/oembed", {
		...
		// new $.fn.oembed.OEmbedProvider("yfrog", "photo", ["yfrog\\.(com|ru|com\\.tr|it|fr|co\\.il|co\\.uk|com\\.pl|pl|eu|us)/.+"], "https://www.yfrog.com/api/oembed", {
		// 	useYQL: "json"
		// }),
		...
		new $.fn.oembed.OEmbedProvider("23hq", "photo", ["23hq.com/[-.\\w@]+/photo/.+"], "https://www.23hq.com/23/oembed", {
			useYQL: "json"
		}),
		...
		new $.fn.oembed.OEmbedProvider("dipity", "rich", ["dipity.com/timeline/.+"], 'https://www.dipity.com/oembed/timeline/', {
			useYQL: 'json'
		}),
		new $.fn.oembed.OEmbedProvider("sketchfab", "rich", ["sketchfab.com/show/.+"], 'https://sketchfab.com/oembed', {
			useYQL: 'json'
		}),
