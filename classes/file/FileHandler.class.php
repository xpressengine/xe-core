...
class FileHandler
{
	 ...
	 * @return void
	 */
	public function removeBlankDir($path)
	{
		if(($path = self::isDir($path)) === FALSE)
		{
			return;
	 ...
	 * @return void
	 */
	public function removeFilesInDir($path)
	{
	 ...
	 */
	public static function getRemoteResource($url, $body = null, $timeout = 3, $method = 'GET', $content_type = null, $headers = array(), $cookies = array(), $post_data = array())
	{
		try
		{
			requirePear();
	 ...
	 */
	public static function getRemoteFile($url, $target_filename, $body = null, $timeout = 3, $method = 'GET', $content_type = null, $headers = array())
	{
