<?php
	...
	$lang->cmd_check_api_key_fail = '공식사이트에서 발급받은 api_key를 다시 한번 확인 부탁 드립니다.';
	$lang->cmd_check_api_key_success = '사용가능한 api_key입니다.';

	$lang->analytics_none_data = '이 기간에는 관련 데이터가 없습니다.';
    $lang->analytics_data_loading = '데이터 로딩중입니다.';
	...
	$lang->cmd_analytics_recent_visiting_status = '최근 방문 현황';
	$lang->cmd_analytics_visiting_pattern_in_cycle = '주기별 방문 패턴';
	$lang->cmd_analytics_visitor_behaviour = '방문자 행태 분석';
