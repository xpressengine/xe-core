...
jQuery(function($){
	// 표의 짝수 행에 클래스 추가
	$('.member .info tr:odd').addClass('odd');
	$('.join .info tr:odd').addClass('odd');
	// 내 프로젝트 목록 저장소 계정 설정 토글
	$('.svnSetup').hide();
	$('.svn .svnToggle').click(function(){$('.svnSetup').toggle();})
	$('.svn .close').click(function(){$('.svnSetup').hide();})
});
