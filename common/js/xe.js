...
function _displayMultimedia(src, width, height, options) {
	...
	if(/\.(gif|jpg|jpeg|bmp|png)$/i.test(src)){
		...
		html += '' + '<embed src="'+src+'" autostart="'+autostart+'"  width="'+width+'" height="'+height+'" flashvars="'+params.flashvars+'" wmode="'+params.wmode+'" allowscriptaccess="never"></embed>' + '</object>';
	}  else {
		...
		html = '<embed src="'+src+'" autostart="'+autostart+'" width="'+width+'" height="'+height+'" allowscriptaccess="never"';
